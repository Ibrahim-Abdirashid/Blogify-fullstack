...
* **CRUD Operations:** Full capability to **C**reate, **R**ead, **U**pdate, and **D**elete blog posts.
...
3.  **Setup Environment Variables:**
    Create a file named **`.env`** in the root directory of the project, and include your Supabase keys:
    ```
    # .env file
